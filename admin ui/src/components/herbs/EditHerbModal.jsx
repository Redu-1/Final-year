...
const EditHerbModal = ({ isOpen, onClose, onSave, herb }) => {
  ...
  // Load herb data when modal opens
  useEffect(() => {
    if (isOpen && herb) {
      setFormData({
        commonName: herb.commonName || '',
        scientificName: herb.scientificName || '',
        partsUsed: herb.partsUsed || 'LEAVES',
        indigenousRegion: herb.indigenousRegion || '',
        ...
        storageInstructions: herb.storageInstructions || '',
        imageUrl: herb.imageUrl || '',
        skinConditions: herb.skinConditions || [],
  ...
  const partsUsedOptions = [
    ...
    { value: 'SHRUB/LEAVES', label: 'Shrub/Leaves' }
  ];
    ...
    <div className="fixed inset-0 z-[9999] overflow-y-auto">
      ...
      <div className="relative flex min-h-full items-center justify-center p-4">
        <div className="relative w-full max-w-5xl transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all">
          ...
          {/* Header - Changed from blue to green gradient */}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-50">Editing: {herb.commonName}</p>
                </div>
              </div>
              <button
                onClick={onClose}
          ...
          {/* Tabs - Changed from blue to green */}
