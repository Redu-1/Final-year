// src/components/recommendations/DeleteRuleModal.jsx
import { X, AlertTriangle } from 'lucide-react';
import Button from '../common/Button';
import ReactDOM from 'react-dom';

const DeleteRuleModal = ({ isOpen, onClose, onConfirm, ruleName }) => {
        ...
        <div className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all">
          ...
          <div className="px-6 py-6">
            ...
            <p className="text-gray-600 text-center mb-6">
              This will permanently delete the recommendation rule{' '}
              <span className="font-semibold text-gray-900">"{ruleName}"</span> 
